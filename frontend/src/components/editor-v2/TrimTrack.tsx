 ...
 * (see CanvasPlayer's skipTrimmedRanges). Clicking back on the pending dot
 * cancels it instead of placing a near-zero-length trim. Right-clicking an
 * existing red segment opens a context menu (the same one ProjectList/
  ...
  return (
    ...
    >
      ...
      {pendingTrimStartSeconds !== null && (
        <div
          className="absolute top-1/2 z-10 h-2.5 w-2.5 -translate-x-1/2 -translate-y-1/2 rounded-full border border-red-900 bg-red-500"
