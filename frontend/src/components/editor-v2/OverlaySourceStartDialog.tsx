...
export function OverlaySourceStartDialog({
  ...
  return (
    <div role="dialog" aria-modal="true" aria-label="Overlay start point" className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4" onClick={onClose}>
